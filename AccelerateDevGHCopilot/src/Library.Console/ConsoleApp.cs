...
public class ConsoleApp
{
    ...
    async Task<ConsoleState> SearchBooks()
    {
        ...
        if (bookItem == null)
        {
            Console.WriteLine($"No physical copies of '{book.Title}' are in the library system.");
            return ConsoleState.PatronDetails;
        }
        ...
        {
            Console.WriteLine($"'{book.Title}' is on loan to another patron. The return due date is {loan.DueDate:d}.");
        }
